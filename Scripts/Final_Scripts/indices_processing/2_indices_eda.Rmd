...
in each climate zone (processed in 1_indexpreparation.Rmd).
(1) Read in all data of each idex for each zone processed in 1_indexpreparation.Rmd
(2) Calculate summary statistics per zone

#Step 1- reading in all data written in 1_indexpreparation.Rmd
```{r}
