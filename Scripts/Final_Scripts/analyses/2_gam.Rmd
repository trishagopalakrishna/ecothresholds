...
analyses_df_noNA_nooutliers <- remove_HAND_outliers(analyses_df)
...
#Step 4a- GAM modelling for step increase pixels
```{r}
#savanna analyses
...
#Step 4b- GAM modelling for step decrease pixels
```{r}
#savanna analyses
...
Sys.time(); step_inc_model <- mgcv::bam( cbind(ndvi_monthly_step_inc, 25- ndvi_monthly_step_inc) ~ s(anthropic_dist, bs= "ts") +
                                          ...
                                          ti(mean_savanna_percentage,trend_burnedarea, trend_annualtemp, bs=c("ts", "ts", "ts"), k=c(5,5,5)) +
                                          ti(mean_grass_percentage,trend_burnedarea, trend_annualtemp, bs=c("ts", "ts", "ts"), k=c(5,5,5)) +
                                          ti(mean_forest_percentage,trend_burnedarea, trend_annualtemp, bs=c("ts", "ts", "ts"), k=c(5,5,5)) +
                                           
                                          ti(mean_savanna_percentage,trend_burnedarea, trend_re, bs=c("ts", "ts", "ts"), k=c(5,5,5)) +
                                          ti(mean_grass_percentage,trend_burnedarea, trend_re, bs=c("ts", "ts", "ts"), k=c(5,5,5)) +
                                          ti(mean_forest_percentage,trend_burnedarea, trend_re, bs=c("ts", "ts", "ts"), k=c(5,5,5)) + 
                                          
                                          ti(mean_savanna_percentage,trend_burnedarea, trend_heatwave, bs=c("ts", "ts", "ts"), k=c(5,5,5)) +
                                          ti(mean_grass_percentage,trend_burnedarea, trend_heatwave, bs=c("ts", "ts", "ts"), k=c(5,5,5)) +
                                          ti(mean_forest_percentage,trend_burnedarea, trend_heatwave, bs=c("ts", "ts", "ts"), k=c(5,5,5)) + 
                                           
                                          ti(mean_savanna_percentage,trend_burnedarea, trend_spei, bs=c("ts", "ts", "ts"), k=c(5,5,5)) +
                                          ti(mean_grass_percentage,trend_burnedarea, trend_spei, bs=c("ts", "ts", "ts"), k=c(5,5,5)) +
                                          ti(mean_forest_percentage,trend_burnedarea, trend_spei, bs=c("ts", "ts", "ts"), k=c(5,5,5)) + 
                                           
                                          ti(mean_savanna_percentage,trend_burnedarea, anthropic_dist, bs=c("ts", "ts", "ts"), k=c(5,5,5)) +
                                          ti(mean_grass_percentage,trend_burnedarea, anthropic_dist, bs=c("ts", "ts", "ts"), k=c(5,5,5)) +
                                          ti(mean_forest_percentage,trend_burnedarea, anthropic_dist, bs=c("ts", "ts", "ts"), k=c(5,5,5)),
...
#write_rds(step_inc_model, here("Scripts", "Final_Scripts", "analyses", "all_vars_step_inc_model.rds"))
#write_rds(step_dec_model, here("Scripts", "Final_Scripts", "analyses", "all_vars_step_dec_model.rds"))
...
inc_gam <- read_rds(here("Scripts", "Final_Scripts", "analyses", "Archive", "all_vars_step_inc_model.rds"))
dec_gam <- read_rds(here("Scripts", "Final_Scripts", "analyses", "Archive" ,"all_vars_step_dec_model.rds"))
...
grid_creation_prediction <- function (df_analyses, xaxis_variable_in_quotes, 
  ...
  pred <- predict(gam_model, newdata = newd, type="terms") 
...
```{r}
inc_pred_savanna_trend_at_re <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", 
                                                         savanna_gam_step_inc)
dec_pred_savanna_trend_at_re <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", 
                                                         savanna_gam_step_dec)
inc_pred_grass_trend_at_re <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", 
                                                         grass_gam_step_inc)
dec_pred_grass_trend_at_re <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", 
                                                         grass_gam_step_dec)
inc_pred_forest_trend_at_re <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", 
                                                         forest_gam_step_inc)
dec_pred_forest_trend_at_re <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", 
                                                         forest_gam_step_dec)

plot_inc_savanna_trend_at_re <- select_effects_function(savanna_df_noNA_nooutliers, 
                                                        "trend_annualtemp", 
                                                        inc_pred_savanna_trend_at_re, 
                                                        c(4,14), #4,14 are column indices after removing s(x,y), ti (mean_at, x,y) and ti(trend_annualtemp, x,y)
                                                        "more_uniform_seasonality", "nochange", "less_uniform_seasonality")
plot_inc_forest_trend_at_re <- select_effects_function(forest_df_noNA_nooutliers, 
                                                       "trend_annualtemp", inc_pred_forest_trend_at_re,
                                                       c(4,14),
                                                       "more_uniform_seasonality", "nochange", "less_uniform_seasonality")
plot_inc_grass_trend_at_re <- select_effects_function(grass_df_noNA_nooutliers, 
                                                      "trend_annualtemp", 
                                                      inc_pred_grass_trend_at_re, 
                                                      c(4,14),
                                                      "more_uniform_seasonality", "nochange", "less_uniform_seasonality")
plot_dec_savanna_trend_at_re <- select_effects_function(savanna_df_noNA_nooutliers, 
                                                        "trend_annualtemp", 
                                                        dec_pred_savanna_trend_at_re,
                                                        c(4,14),
                                                        "more_uniform_seasonality", "nochange", "less_uniform_seasonality")
plot_dec_forest_trend_at_re <- select_effects_function(forest_df_noNA_nooutliers, 
                                                       "trend_annualtemp", 
                                                       dec_pred_forest_trend_at_re, 
                                                       c(4,14),
                                                       "more_uniform_seasonality", "nochange", "less_uniform_seasonality")
plot_dec_grass_trend_at_re <- select_effects_function(grass_df_noNA_nooutliers, 
                                                      "trend_annualtemp", 
                                                      dec_pred_grass_trend_at_re, 
                                                      c(4,14),
                                                      "more_uniform_seasonality", "nochange", "less_uniform_seasonality")


savanna_plot_df <- combined_plot_df_prep(plot_inc_savanna_trend_at_re, plot_dec_savanna_trend_at_re, "Savanna")
grass_plot_df <- combined_plot_df_prep(plot_inc_grass_trend_at_re, plot_dec_grass_trend_at_re, "Grass")
forest_plot_df <- combined_plot_df_prep(plot_inc_forest_trend_at_re, plot_dec_forest_trend_at_re, "Forest")
...
ggsave (here("Outputs", "AnalysesResults", "GAMResults", "TwoWay_InteractionResults", "trend_annualtemp_re.png"), annualtemp_re_vegformation,
...
```{r}
inc_pred_savanna_trend_heatwave_spei <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "trend_heatwave", "trend_spei", 
                                                         savanna_gam_step_inc)
dec_pred_savanna_trend_heatwave_spei <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "trend_heatwave", "trend_spei", 
                                                         savanna_gam_step_dec)
inc_pred_grass_trend_heatwave_spei <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                         "trend_heatwave", "trend_spei", 
                                                         grass_gam_step_inc)
dec_pred_grass_trend_heatwave_spei <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                        "trend_heatwave", "trend_spei", 
                                                         grass_gam_step_dec)
inc_pred_forest_trend_heatwave_spei <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "trend_heatwave", "trend_spei", 
                                                         forest_gam_step_inc)
dec_pred_forest_trend_heatwave_spei <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "trend_heatwave", "trend_spei", 
                                                         forest_gam_step_dec)

plot_inc_savanna_trend_heatwave_spei <- select_effects_function(savanna_df_noNA_nooutliers, 
                                                        "trend_heatwave", 
                                                        inc_pred_savanna_trend_heatwave_spei, 
                                                        c(5,15),
                                                        "more_dry", "nochange", "more_wet")
plot_inc_forest_trend_heatwave_spei <- select_effects_function(forest_df_noNA_nooutliers, 
                                                       "trend_heatwave", inc_pred_forest_trend_heatwave_spei,
                                                       c(5,15),
                                                       "more_dry", "nochange", "more_wet")
plot_inc_grass_trend_heatwave_spei <- select_effects_function(grass_df_noNA_nooutliers, 
                                                      "trend_heatwave", 
                                                      inc_pred_grass_trend_heatwave_spei, 
                                                     c(5,15),
                                                      "more_dry", "nochange", "more_wet")
plot_dec_savanna_trend_heatwave_spei <- select_effects_function(savanna_df_noNA_nooutliers, 
                                                        "trend_heatwave", 
                                                        dec_pred_savanna_trend_heatwave_spei,
                                                        c(5,15),
                                                        "more_dry", "nochange", "more_wet")
plot_dec_forest_trend_heatwave_spei <- select_effects_function(forest_df_noNA_nooutliers, 
                                                       "trend_heatwave", 
                                                       dec_pred_forest_trend_heatwave_spei, 
                                                       c(5,15),
                                                       "more_dry", "nochange", "more_wet")
plot_dec_grass_trend_heatwave_spei <- select_effects_function(grass_df_noNA_nooutliers, 
                                                      "trend_heatwave", 
                                                      dec_pred_grass_trend_heatwave_spei, 
                                                      c(5,15),
                                                      "more_dry", "nochange", "more_wet")

savanna_plot_df <- combined_plot_df_prep(plot_inc_savanna_trend_heatwave_spei, plot_dec_savanna_trend_heatwave_spei, "Savanna")
grass_plot_df <- combined_plot_df_prep(plot_inc_grass_trend_heatwave_spei, plot_dec_grass_trend_heatwave_spei, "Grass")
forest_plot_df <- combined_plot_df_prep(plot_inc_forest_trend_heatwave_spei, plot_dec_forest_trend_heatwave_spei, "Forest")

heatwave_spei_plot_df <- bind_rows(savanna_plot_df, grass_plot_df, forest_plot_df)

heatwave_spei_vegformation <- plot_function(heatwave_spei_plot_df , "trend_heatwave")
...
remove(savanna_plot_df, grass_plot_df, forest_plot_df, plot_dec_grass_trend_heatwave_spei, plot_dec_forest_trend_heatwave_spei,plot_dec_savanna_trend_heatwave_spei,
      plot_inc_grass_trend_heatwave_spei, plot_inc_forest_trend_heatwave_spei, plot_inc_savanna_trend_heatwave_spei,dec_pred_forest_trend_heatwave_spei, inc_pred_forest_trend_heatwave_spei,
      dec_pred_grass_trend_heatwave_spei, inc_pred_grass_trend_heatwave_spei, dec_pred_savanna_trend_heatwave_spei, inc_pred_savanna_trend_heatwave_spei   )
```

#Step 5a (iii) Mean anthropic distance and trend in burnedarea across veg formation
```{r}
inc_pred_savanna_trend_anthropicdist_burnedarea <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "anthropic_dist", "trend_burnedarea", 
                                                         savanna_gam_step_inc)
dec_pred_savanna_trend_anthropicdist_burnedarea <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "anthropic_dist", "trend_burnedarea", 
                                                         savanna_gam_step_dec)
inc_pred_grass_trend_anthropicdist_burnedarea <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                         "anthropic_dist", "trend_burnedarea", 
                                                         grass_gam_step_inc)
dec_pred_grass_trend_anthropicdist_burnedarea <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                        "anthropic_dist", "trend_burnedarea", 
                                                         grass_gam_step_dec)
inc_pred_forest_trend_anthropicdist_burnedarea <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "anthropic_dist", "trend_burnedarea", 
                                                         forest_gam_step_inc)
dec_pred_forest_trend_anthropicdist_burnedarea <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "anthropic_dist", "trend_burnedarea", 
                                                         forest_gam_step_dec)


plot_inc_savanna_trend_anthropicdist_burnedarea <- select_effects_function(savanna_df_noNA_nooutliers, 
                                                        "anthropic_dist", 
                                                        inc_pred_savanna_trend_anthropicdist_burnedarea, 
                                                        c(1,16),
                                                        "more_burnedarea", "nochange", "less_burnedarea")
plot_inc_forest_trend_anthropicdist_burnedarea<- select_effects_function(forest_df_noNA_nooutliers, 
                                                       "anthropic_dist", 
                                                       inc_pred_forest_trend_anthropicdist_burnedarea,
                                                      c(1,16),
                                                       "more_burnedarea", "nochange", "less_burnedarea")
plot_inc_grass_trend_anthropicdist_burnedarea <- select_effects_function(grass_df_noNA_nooutliers, 
                                                      "anthropic_dist", 
                                                      inc_pred_grass_trend_anthropicdist_burnedarea, 
                                                     c(1,16),
                                                      "more_burnedarea", "nochange", "less_burnedarea")
plot_dec_savanna_trend_anthropicdist_burnedarea<- select_effects_function(savanna_df_noNA_nooutliers, 
                                                        "anthropic_dist", 
                                                        dec_pred_savanna_trend_anthropicdist_burnedarea,
                                                        c(1,16),
                                                        "more_burnedarea", "nochange", "less_burnedarea")
plot_dec_forest_trend_anthropicdist_burnedarea <- select_effects_function(forest_df_noNA_nooutliers, 
                                                       "anthropic_dist", 
                                                       dec_pred_forest_trend_anthropicdist_burnedarea, 
                                                       c(1,16),
                                                       "more_burnedarea", "nochange", "less_burnedarea")
plot_dec_grass_trend_anthropicdist_burnedarea <- select_effects_function(grass_df_noNA_nooutliers, 
                                                      "anthropic_dist", 
                                                      dec_pred_grass_trend_anthropicdist_burnedarea, 
                                                      c(1,16),
                                                      "more_burnedarea", "nochange", "less_burnedarea")

savanna_plot_df <- combined_plot_df_prep(plot_inc_savanna_trend_anthropicdist_burnedarea , plot_dec_savanna_trend_anthropicdist_burnedarea , "Savanna")
grass_plot_df <- combined_plot_df_prep(plot_inc_grass_trend_anthropicdist_burnedarea , plot_dec_grass_trend_anthropicdist_burnedarea , "Grass")
forest_plot_df <- combined_plot_df_prep(plot_inc_forest_trend_anthropicdist_burnedarea , plot_dec_forest_trend_anthropicdist_burnedarea , "Forest")

anthropicdist_burnedarea_plot_df <- bind_rows(savanna_plot_df, grass_plot_df, forest_plot_df)

anthropicdist_burnedarea_vegformation <- plot_function(anthropicdist_burnedarea_plot_df , "anthropic_dist")
...
remove(savanna_plot_df, grass_plot_df, forest_plot_df, plot_dec_grass_trend_anthropicdist_burnedarea, plot_dec_forest_trend_anthropicdist_burnedarea,plot_dec_savanna_trend_anthropicdist_burnedarea,
      plot_inc_grass_trend_anthropicdist_burnedarea, plot_inc_forest_trend_anthropicdist_burnedarea, plot_inc_savanna_trend_anthropicdist_burnedarea,dec_pred_forest_trend_anthropicdist_burnedarea, inc_pred_forest_trend_anthropicdist_burnedarea,
      dec_pred_grass_trend_anthropicdist_burnedarea, inc_pred_grass_trend_anthropicdist_burnedarea, dec_pred_savanna_trend_anthropicdist_burnedarea, inc_pred_savanna_trend_anthropicdist_burnedarea   )
```

#Step 5a (iv) Mean anthropic distance and mean veg formation
```{r}
inc_pred_savanna_anthropicdist_vegformation <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "anthropic_dist", "mean_savannapercentage", 
                                                         savanna_gam_step_inc)
dec_pred_savanna_anthropicdist_vegformation  <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "anthropic_dist", "mean_savannapercentage", 
                                                         savanna_gam_step_dec)
inc_pred_grass_anthropicdist_vegformation  <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                         "anthropic_dist", "mean_grasspercentage", 
                                                         grass_gam_step_inc)
dec_pred_grass_anthropicdist_vegformation  <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                        "anthropic_dist", "mean_grasspercentage", 
                                                         grass_gam_step_dec)
inc_pred_forest_anthropicdist_vegformation  <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "anthropic_dist", "mean_forestpercentage", 
                                                         forest_gam_step_inc)
dec_pred_forest_anthropicdist_vegformation  <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "anthropic_dist", "mean_forestpercentage", 
                                                         forest_gam_step_dec)

plot_inc_savanna_anthropicdist_vegformation <- select_effects_function(savanna_df_noNA_nooutliers, 
                                                        "anthropic_dist", 
                                                        inc_pred_savanna_anthropicdist_vegformation, 
                                                        c(1,17),
                                                        "low", "medium", "high")
plot_inc_forest_anthropicdist_vegformation <- select_effects_function(forest_df_noNA_nooutliers, 
                                                       "anthropic_dist", inc_pred_forest_anthropicdist_vegformation,
                                                       c(1,17),
                                                       "low", "medium", "high")
plot_inc_grass_anthropicdist_vegformation <- select_effects_function(grass_df_noNA_nooutliers, 
                                                      "anthropic_dist", 
                                                      inc_pred_grass_anthropicdist_vegformation, 
                                                     c(1,17),
                                                      "low", "medium", "high")
plot_dec_savanna_anthropicdist_vegformation <- select_effects_function(savanna_df_noNA_nooutliers, 
                                                        "anthropic_dist", 
                                                        dec_pred_savanna_anthropicdist_vegformation,
                                                        c(1,17),
                                                        "low", "medium", "high")
plot_dec_forest_anthropicdist_vegformation <- select_effects_function(forest_df_noNA_nooutliers, 
                                                       "anthropic_dist", 
                                                       dec_pred_forest_anthropicdist_vegformation, 
                                                      c(1,17),
                                                       "low", "medium", "high")
plot_dec_grass_anthropicdist_vegformation <- select_effects_function(grass_df_noNA_nooutliers, 
                                                      "anthropic_dist", 
                                                      dec_pred_grass_anthropicdist_vegformation, 
                                                      c(1,17),
                                                      "low", "medium", "high")


savanna_plot_df <- combined_plot_df_prep(plot_inc_savanna_anthropicdist_vegformation , plot_dec_savanna_anthropicdist_vegformation , "Savanna")
grass_plot_df <- combined_plot_df_prep(plot_inc_grass_anthropicdist_vegformation , plot_dec_grass_anthropicdist_vegformation , "Grass")
forest_plot_df <- combined_plot_df_prep(plot_inc_forest_anthropicdist_vegformation , plot_dec_forest_anthropicdist_vegformation , "Forest")
...
ggsave (here("Outputs", "AnalysesResults", "GAMResults", "TwoWay_InteractionResults", "anthropicdist_meanvegformation.png"), anthropicdist_vegformation_vegformation,
        dpi = 700, height = 25, width=25, units = "cm")

remove(savanna_plot_df, grass_plot_df, forest_plot_df, plot_dec_grass_anthropicdist_vegformation, plot_dec_forest_anthropicdist_vegformation,plot_dec_savanna_anthropicdist_vegformation,
      plot_inc_grass_anthropicdist_vegformation, plot_inc_forest_anthropicdist_vegformation, plot_inc_savanna_anthropicdist_vegformation,dec_pred_forest_anthropicdist_vegformation, inc_pred_forest_anthropicdist_vegformation,
      dec_pred_grass_anthropicdist_vegformation, inc_pred_grass_anthropicdist_vegformation, dec_pred_savanna_anthropicdist_vegformation, inc_pred_savanna_anthropicdist_vegformation)
```

#Step 5a (v) Trend in burnedarea and mean veg formation
```{r}
inc_pred_savanna_trend_burnedarea_vegformation <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "trend_burnedarea", "mean_savannapercentage", 
                                                         savanna_gam_step_inc)
dec_pred_savanna_trend_burnedarea_vegformation  <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "trend_burnedarea", "mean_savannapercentage", 
                                                         savanna_gam_step_dec)
inc_pred_grass_trend_burnedarea_vegformation  <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                         "trend_burnedarea", "mean_grasspercentage", 
                                                         grass_gam_step_inc)
dec_pred_grass_trend_burnedarea_vegformation  <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                        "trend_burnedarea", "mean_grasspercentage", 
                                                         grass_gam_step_dec)
inc_pred_forest_trend_burnedarea_vegformation  <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "trend_burnedarea", "mean_forestpercentage", 
                                                         forest_gam_step_inc)
dec_pred_forest_trend_burnedarea_vegformation  <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "trend_burnedarea", "mean_forestpercentage", 
                                                         forest_gam_step_dec)


plot_inc_savanna_trend_burnedarea_vegformation <- select_effects_function(savanna_df_noNA_nooutliers, 
                                                        "trend_burnedarea", 
                                                        inc_pred_savanna_trend_burnedarea_vegformation, 
                                                        c(7,18),
                                                        "low", "medium", "high")
plot_inc_forest_trend_burnedarea_vegformation <- select_effects_function(forest_df_noNA_nooutliers, 
                                                       "trend_burnedarea", inc_pred_forest_trend_burnedarea_vegformation,
                                                       c(7,18),
                                                       "low", "medium", "high")
plot_inc_grass_trend_burnedarea_vegformation <- select_effects_function(grass_df_noNA_nooutliers, 
                                                      "trend_burnedarea", 
                                                      inc_pred_grass_trend_burnedarea_vegformation, 
                                                     c(7,18),
                                                      "low", "medium", "high")
plot_dec_savanna_trend_burnedarea_vegformation <- select_effects_function(savanna_df_noNA_nooutliers, 
                                                        "trend_burnedarea", 
                                                        dec_pred_savanna_trend_burnedarea_vegformation,
                                                        c(7,18),
                                                        "low", "medium", "high")
plot_dec_forest_trend_burnedarea_vegformation <- select_effects_function(forest_df_noNA_nooutliers, 
                                                       "trend_burnedarea", 
                                                       dec_pred_forest_trend_burnedarea_vegformation, 
                                                      c(7,18),
                                                       "low", "medium", "high")
plot_dec_grass_trend_burnedarea_vegformation <- select_effects_function(grass_df_noNA_nooutliers, 
                                                      "trend_burnedarea", 
                                                      dec_pred_grass_trend_burnedarea_vegformation, 
                                                      c(7,18),
                                                      "low", "medium", "high")

savanna_plot_df <- combined_plot_df_prep(plot_inc_savanna_trend_burnedarea_vegformation , plot_dec_savanna_trend_burnedarea_vegformation , "Savanna")
grass_plot_df <- combined_plot_df_prep(plot_inc_grass_trend_burnedarea_vegformation , plot_dec_grass_trend_burnedarea_vegformation , "Grass")
forest_plot_df <- combined_plot_df_prep(plot_inc_forest_trend_burnedarea_vegformation , plot_dec_forest_trend_burnedarea_vegformation , "Forest")
...
ggsave (here("Outputs", "AnalysesResults", "GAMResults", "TwoWay_InteractionResults", "trend_burnedarea_meanvegformation.png"), trend_burnedarea_vegformation_vegformation,
        dpi = 700, height = 25, width=25, units = "cm")

remove(savanna_plot_df, grass_plot_df, forest_plot_df, plot_dec_grass_anthropicdist_vegformation, plot_dec_forest_trend_burnedarea_vegformation,plot_dec_savanna_trend_burnedarea_vegformation,
      plot_inc_grass_trend_burnedarea_vegformation, plot_inc_forest_trend_burnedarea_vegformation, plot_inc_savanna_trend_burnedarea_vegformation,dec_pred_forest_trend_burnedarea_vegformation, inc_pred_forest_trend_burnedarea_vegformation,
      dec_pred_grass_trend_burnedarea_vegformation, inc_pred_grass_trend_burnedarea_vegformation, dec_pred_savanna_trend_burnedarea_vegformation, inc_pred_savanna_trend_burnedarea_vegformation)
```
...
grid_creation_prediction <- function (df_analyses, xaxis_variable_in_quotes, 
  ...
  pred_dec <- predict(gam_model, newdata = df_panel_dec, type="terms")
  pred_dec <- as.data.frame(pred_dec)
  pred_nochange <- predict(gam_model, newdata = df_panel_nochange, type="terms")
  pred_nochange <- as.data.frame(pred_nochange)
  pred_inc <- predict(gam_model, newdata = df_panel_inc, type="terms")
...
plot_function <- function (plot_df, xaxis_var){
  plot_interaction <- ggplot(plot_df, aes(x = .data[[xaxis_var]], y = value,
    ...
    geom_line(aes(color = lines_var_type), linewidth = 1) + facet_grid(VegFormation~panel_var_type)+
    theme_classic() +
    scale_color_manual(values=c("#990066", "#333333", "#336600")) + 
    ylab ("Partial Effect") + theme(legend.title=element_blank())
  plot_interaction
...
#Step 5b (i) - Trends in annual temp, RE, burned area across veg formations
```{r}
inc_pred_savanna_trend_at_re_burnedarea <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", "trend_burnedarea",
                                                         savanna_gam_step_inc)
inc_pred_forest_trend_at_re_burnedarea <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", "trend_burnedarea",
                                                         forest_gam_step_inc)
inc_pred_grass_trend_at_re_burnedarea <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", "trend_burnedarea",
                                                         grass_gam_step_inc)
dec_pred_savanna_trend_at_re_burnedarea <- grid_creation_prediction(savanna_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", "trend_burnedarea",
                                                         savanna_gam_step_dec)
dec_pred_forest_trend_at_re_burnedarea <- grid_creation_prediction(forest_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", "trend_burnedarea",
                                                         forest_gam_step_dec)
dec_pred_grass_trend_at_re_burnedarea <- grid_creation_prediction(grass_df_noNA_nooutliers, 
                                                         "trend_annualtemp", "trend_re", "trend_burnedarea",
                                                         grass_gam_step_dec)


plot_inc_savanna_trend_at_re_burnedarea <- select_effects_function(savanna_df_noNA_nooutliers, "trend_annualtemp", 
                                 inc_pred_savanna_trend_at_re_burnedarea[[3]],
                                 inc_pred_savanna_trend_at_re_burnedarea[[2]],
                                 inc_pred_savanna_trend_at_re_burnedarea[[1]],
                                 c(4,14,19),
                                "more.uniform.rainfall_decburn", "no.trend.rainfall.seasonality_decburn", "more.seasonal.rainfall_decburn",
                                "more.uniform.rainfall_nochange", "no.trend.rainfall.seasonality_nochange", "more.seasonal.rainfall_nochange",
                                "more.uniform.rainfall_incburn", "no.trend.rainfall.seasonality_incburn", "more.seasonal.rainfall_incburn")
plot_inc_forest_trend_at_re_burnedarea <- select_effects_function(savanna_df_noNA_nooutliers, "trend_annualtemp", 
                                 inc_pred_forest_trend_at_re_burnedarea[[3]],
                                 inc_pred_forest_trend_at_re_burnedarea[[2]],
                                 inc_pred_forest_trend_at_re_burnedarea[[1]],
                                 c(4,14,19),
                                "more.uniform.rainfall_decburn", "no.trend.rainfall.seasonality_decburn", "more.seasonal.rainfall_decburn",
                                "more.uniform.rainfall_nochange", "no.trend.rainfall.seasonality_nochange", "more.seasonal.rainfall_nochange",
                                "more.uniform.rainfall_incburn", "no.trend.rainfall.seasonality_incburn", "more.seasonal.rainfall_incburn")
plot_inc_grass_trend_at_re_burnedarea <- select_effects_function(savanna_df_noNA_nooutliers, "trend_annualtemp", 
                                 inc_pred_grass_trend_at_re_burnedarea[[3]],
                                 inc_pred_grass_trend_at_re_burnedarea[[2]],
                                 inc_pred_grass_trend_at_re_burnedarea[[1]],
                                 c(4,14,19),
                                "more.uniform.rainfall_decburn", "no.trend.rainfall.seasonality_decburn", "more.seasonal.rainfall_decburn",
                                "more.uniform.rainfall_nochange", "no.trend.rainfall.seasonality_nochange", "more.seasonal.rainfall_nochange",
                                "more.uniform.rainfall_incburn", "no.trend.rainfall.seasonality_incburn", "more.seasonal.rainfall_incburn")
plot_dec_savanna_trend_at_re_burnedarea <- select_effects_function(savanna_df_noNA_nooutliers, "trend_annualtemp", 
                                 dec_pred_savanna_trend_at_re_burnedarea[[3]],
                                 dec_pred_savanna_trend_at_re_burnedarea[[2]],
                                 dec_pred_savanna_trend_at_re_burnedarea[[1]],
                                 c(4,14,19),
                                "more.uniform.rainfall_decburn", "no.trend.rainfall.seasonality_decburn", "more.seasonal.rainfall_decburn",
                                "more.uniform.rainfall_nochange", "no.trend.rainfall.seasonality_nochange", "more.seasonal.rainfall_nochange",
                                "more.uniform.rainfall_incburn", "no.trend.rainfall.seasonality_incburn", "more.seasonal.rainfall_incburn")
plot_dec_forest_trend_at_re_burnedarea <- select_effects_function(savanna_df_noNA_nooutliers, "trend_annualtemp", 
                                 dec_pred_forest_trend_at_re_burnedarea[[3]],
                                 dec_pred_forest_trend_at_re_burnedarea[[2]],
                                 dec_pred_forest_trend_at_re_burnedarea[[1]],
                                 c(4,14,19),
                                "more.uniform.rainfall_decburn", "no.trend.rainfall.seasonality_decburn", "more.seasonal.rainfall_decburn",
                                "more.uniform.rainfall_nochange", "no.trend.rainfall.seasonality_nochange", "more.seasonal.rainfall_nochange",
                                "more.uniform.rainfall_incburn", "no.trend.rainfall.seasonality_incburn", "more.seasonal.rainfall_incburn")
plot_dec_grass_trend_at_re_burnedarea <- select_effects_function(savanna_df_noNA_nooutliers, "trend_annualtemp", 
                                 dec_pred_grass_trend_at_re_burnedarea[[3]],
                                 dec_pred_grass_trend_at_re_burnedarea[[2]],
                                 dec_pred_grass_trend_at_re_burnedarea[[1]],
                                 c(4,14,19),
                                "more.uniform.rainfall_decburn", "no.trend.rainfall.seasonality_decburn", "more.seasonal.rainfall_decburn",
                                "more.uniform.rainfall_nochange", "no.trend.rainfall.seasonality_nochange", "more.seasonal.rainfall_nochange",
                                "more.uniform.rainfall_incburn", "no.trend.rainfall.seasonality_incburn", "more.seasonal.rainfall_incburn")

savanna_plot_df <- combined_plot_df_prep(plot_inc_savanna_trend_at_re_burnedarea , plot_dec_savanna_trend_at_re_burnedarea, "Savanna")
grass_plot_df <- combined_plot_df_prep(plot_inc_forest_trend_at_re_burnedarea, plot_dec_forest_trend_at_re_burnedarea, "Grass")
forest_plot_df <- combined_plot_df_prep(plot_inc_grass_trend_at_re_burnedarea , plot_dec_grass_trend_at_re_burnedarea, "Forest")


annualtemp_re_burnedarea_plot_df <- bind_rows(savanna_plot_df, grass_plot_df, forest_plot_df)

annualtemp_re_vegformation <- plot_function(annualtemp_re_burnedarea_plot_df , "trend_annualtemp")
...
#Step 5b (ii) - Trends in heatwaves, SPEI, burned area across veg formations
```{r}
...
#Step 5b (iii) - Trends in heatwaves, SPEI across veg formations