...
savannapercentage <- rast(here("Outputs", "OtherVariables", "Formations_Heterogeniety", "mean_savanna_percentage_5km_2002_2021.tif"))
```
...
remove(anthropic_dist, burnedarea, hand, re, at, heatwave, spei, savannapercentage)
