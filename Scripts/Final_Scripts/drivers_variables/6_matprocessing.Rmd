...
gee_at<- rast(here("Data", "Climate", "Annual_Temp_ERA5_1km.tif"))
gee_at
...
remove(era_at_crop)
writeRaster(era_at_mask, here("Outputs", "OtherVariables", "Climate", "at_1981_2021_1km.tif"))
```
...
tmap_animation(animation_x_time_map, filename = here("Outputs", "OtherVariables", "Climate", "annual_temperature_1981_2021_1km.gif"),
...
```{r}
at_mask<- rast(here("Outputs", "OtherVariables", "Climate", "at_1981_2021_1km.tif"))
...
writeRaster(theilsen_at, here("Outputs", "OtherVariables", "Climate", "theilsen_at_1km.tif"))
...
tmap_save(anomoly_results_map, here("Outputs", "OtherVariables", "Climate", "anomoly_annualtemp_methods_results_1km.png"),
