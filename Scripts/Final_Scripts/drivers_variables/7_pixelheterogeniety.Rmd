...
##tic(); lulc<- do.call(mosaic,raster_list); toc() 
##writeRaster(lulc, here("Data", "Mapbiomas_raw", "mosaiced_lulc.tif"))

# d_trans<- st_read(here ("Data", "Cattelanetal_Clustering", "cerrado_climate_zones.shp"))
# d_trans<- st_transform(d_trans, crs = 4326)
# cerrado<- d_trans %>% st_union()
# 
# lulc_crop<- terra::crop(lulc, vect(cerrado))
# lulc_mask<- terra::mask(lulc_crop, vect(cerrado))
# remove(lulc_crop)
# writeRaster(lulc_mask, here("Data", "Mapbiomas_raw", "cerrado_lulc.tif"))
