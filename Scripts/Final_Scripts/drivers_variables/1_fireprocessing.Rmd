...
prop_aggregate <- function(binaryburn_raster) {
  terra::project(
    terra::segregate(binaryburn_raster), at[[1]],# segregate()- binary (0/1) of classes 0,3,4,12
    method = "average", res = res(at)[1]
  )
}
...
writeRaster(theilsen_burnedarea, here("Outputs", "OtherVariables", "Fire", "theilsen_burnedarea_1km.tif"))
