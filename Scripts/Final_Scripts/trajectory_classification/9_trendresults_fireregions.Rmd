...
write_rds(plot_monthly_ndvi_agg , here("Outputs", "TrendsResults", "Figures", "agg_trajectories_fireregions.rdata"))
...
agg_barplot <- ggplot(df_agg, aes(y = area_sqkm/1000, x = factor(Region, 
                            levels = c("LS_P4", "HFA_P4", "LFA_P4")), fill =factor(TrajectoryType))) +
