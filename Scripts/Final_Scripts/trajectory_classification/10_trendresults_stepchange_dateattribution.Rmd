...
(1) Data input of disaggregated trajectory results for all indices and annual and monthly timesteps at 1km spatial resolution (only for swin=11)
...
#increases
Sys.time(); raster_inc_annual_ndvi_date <- rasterize_stepdf_function_year(inc_annual_ndvi_date); Sys.time()
Sys.time(); raster_inc_annual_evi_date <- rasterize_stepdf_function_year(inc_annual_evi_date); Sys.time()
Sys.time(); raster_inc_annual_aniso_date <- rasterize_stepdf_function_year(inc_annual_aniso_date); Sys.time()
Sys.time(); raster_inc_monthly_ndvi_date  <- rasterize_stepdf_function_year(inc_monthly_ndvi_date); Sys.time()
Sys.time(); raster_inc_monthly_evi_date  <- rasterize_stepdf_function_year(inc_monthly_evi_date); Sys.time()
Sys.time(); raster_inc_monthly_aniso_date  <- rasterize_stepdf_function_year(inc_monthly_aniso_date); Sys.time()

#decreases
Sys.time(); raster_dec_annual_ndvi_date <- rasterize_stepdf_function_year(dec_annual_ndvi_date); Sys.time()
Sys.time(); raster_dec_annual_evi_date <- rasterize_stepdf_function_year(dec_annual_evi_date); Sys.time()
Sys.time(); raster_dec_annual_aniso_date <- rasterize_stepdf_function_year(dec_annual_aniso_date); Sys.time()
Sys.time(); raster_dec_monthly_ndvi_date  <- rasterize_stepdf_function_year(dec_monthly_ndvi_date); Sys.time()
Sys.time(); raster_dec_monthly_evi_date  <- rasterize_stepdf_function_year(dec_monthly_evi_date); Sys.time()
Sys.time(); raster_dec_monthly_aniso_date  <- rasterize_stepdf_function_year(dec_monthly_aniso_date); Sys.time()
...
Sys.time(); raster_inc_monthly_ndvi_date_month <- rasterize_stepdf_function_month(inc_monthly_ndvi_date); Sys.time()
Sys.time(); raster_inc_monthly_evi_date_month <- rasterize_stepdf_function_month(inc_monthly_evi_date); Sys.time()
Sys.time(); raster_inc_monthly_aniso_date_month <- rasterize_stepdf_function_month(inc_monthly_aniso_date); Sys.time()

Sys.time(); raster_dec_monthly_ndvi_date_month  <- rasterize_stepdf_function_month(dec_monthly_ndvi_date); Sys.time()
Sys.time(); raster_dec_monthly_evi_date_month <- rasterize_stepdf_function_month(dec_monthly_evi_date); Sys.time()
Sys.time(); raster_dec_monthly_aniso_date_month <- rasterize_stepdf_function_month(dec_monthly_aniso_date); Sys.time()
