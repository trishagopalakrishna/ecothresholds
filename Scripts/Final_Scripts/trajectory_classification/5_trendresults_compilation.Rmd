...
(2) Aggregate trajectories to increase, decrease and no trend
(2) Map plot of seperate and aggregated trajectories
(3) Make barplot of results across the three indices- for seperate and aggregate trajectory types
...
#Step 2 - aggregating trajectory types to increase, decrease and no trend
```{r}
...
writeRaster(studyarea_annual_ndvi1km_aggregated_trajectories, here("Outputs", "TrendsResults", "aggregate_trajectory_results", "monthly_ndvi1km_aggregated.tif"))
...
#Step 3- maps of swin11 trend results considering the individual trajectories
```{r}
d_trans<- st_read(here ("Data", "Cattelanetal_Clustering", "cerrado_climate_zones.shp"))
d_trans<- st_transform(d_trans, crs = 4326)
d_trans<- d_trans %>% mutate(area_km= terra::expanse(vect(d_trans), unit="km"))
...
writeRaster(annual_ndvi_5km_counttrajectorytypes, here("Outputs", "TrendsResults", "results_rasters" , "annual", "binary_count_5km", "annualswin11_ndvi_count_5km.tif"), overwrite =T)
...
writeRaster(monthly_ndvi_5km_counttrajectorytypes, here("Outputs", "TrendsResults", "results_rasters" , "monthly", "binary_count_5km", "monthlyswin11_ndvi_count_5km.tif"), overwrite =T)
...
writeRaster(annual_evi_5km_counttrajectorytypes , here("Outputs", "TrendsResults", "results_rasters" , "annual", "binary_count_5km",  "annualswin11_evi_count_5km.tif"), overwrite= T)
...
writeRaster(monthly_evi_5km_counttrajectorytypes, here("Outputs", "TrendsResults", "results_rasters" , "monthly" , "binary_count_5km", "monthlyswin11_evi_count_5km.tif"), overwrite = T)
...
writeRaster(annual_aniso_5km_counttrajectorytypes , here("Outputs", "TrendsResults", "results_rasters" , "annual", "binary_count_5km",  "annualswin11_aniso_count_5km.tif"), overwrite = T)
...
writeRaster(monthly_aniso_5km_counttrajectorytypes, here("Outputs", "TrendsResults", "results_rasters" , "monthly" , "binary_count_5km", "monthlyswin11_aniso_count_5km.tif"), overwrite = T)
