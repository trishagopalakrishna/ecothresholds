...
count_pixels_specific_trajectory_function <- function (trajectories_1km_raster){
  ...
  trajectories_studyarea <- terra::mask(trajectories_1km_raster, threshold20_1km)
  
  x_1km_sameextent <- terra::resample(terra::segregate(trajectories_studyarea), trajectories_1km_raster, method = "near")
