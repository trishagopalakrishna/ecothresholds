...
Sys.time(); bind_files_function("NDVI", "swindow_11","central"); Sys.time()
Sys.time(); bind_files_function("NDVI", "swindow_11","eastern"); Sys.time()
Sys.time(); bind_files_function("NDVI", "swindow_1","southern"); Sys.time()
...
Sys.time(); bind_files_function("EVI", "swindow_11","central"); Sys.time()
Sys.time(); bind_files_function("EVI", "swindow_11","eastern"); Sys.time()
Sys.time(); bind_files_function("EVI", "swindow_11","southern"); Sys.time()
...
Sys.time(); bind_files_function("anisoEVI", "swindow_11","central"); Sys.time()
Sys.time(); bind_files_function("anisoEVI", "swindow_11","eastern"); Sys.time()
Sys.time(); bind_files_function("anisoEVI", "swindow_11","southern"); Sys.time()

Sys.time(); bind_files_function("anisoEVI", "swindow_7","central"); Sys.time()
Sys.time(); bind_files_function("anisoEVI", "swindow_7","eastern"); Sys.time()
Sys.time(); bind_files_function("anisoEVI", "swindow_7","southern"); Sys.time()

Sys.time(); bind_files_function("anisoEVI", "swindow_periodic","central"); Sys.time()
Sys.time(); bind_files_function("anisoEVI", "swindow_periodic","eastern"); Sys.time()
Sys.time(); bind_files_function("anisoEVI", "swindow_periodic","southern"); Sys.time()
