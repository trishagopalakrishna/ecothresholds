...
############## poitns in each "name
pivot_summary_df1<- summary_df %>% dplyr::select(c(Name, Year, Month, Time, meananiso_acrosspoints, meanNDVI_acrosspoints, meanEVI_acrosspoints)) %>%
  pivot_longer(5:7)
...
remove(summary_df, evi_summary_statistics, ndvi_summary_statistics)
...
ggsave(here("Data", "Lewisetal2022_ChapadaNP_PhysiognomyMaps", "anisoEVI_NDVI_forallJansFebsacrossYears_byname.png"),p, 
       dpi=700, height = 25, width = 25, units = "cm")
remove(p, evi_summary_statistics2, ndvi_summary_statistics2, summary_df)
