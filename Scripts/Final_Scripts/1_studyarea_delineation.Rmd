...
for (i in x_thresholds){
  ...
  writeRaster(threshold_mapbiomas_mask, here("Data", "Masks_to_define_pixelsofinterest", 
                                             "Mapbiomas_anthropic_mask","thresholded_mapbiomas_masks", paste0("thresholded_masks_",i, ".tif")))
                                             
  print ("Next i")
}

threshold_function<- function (x){
  ifelse(max(x)>i, NA, x) #change threshold to 0.1,0.2....
  }
...
#3. Example map of thresholded rasters
#lines 51- 57
