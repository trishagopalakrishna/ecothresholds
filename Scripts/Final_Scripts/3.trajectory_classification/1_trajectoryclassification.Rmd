...
```
##Introduction
In this script I complete the trajectory shape analyses for each index, each swin setting and each climate zone.
(1) Trajectory classification function
(2) Set up core parallelization
(3) Apply function for annual timesteps
(4) Apply function for monthly timesteps

#Step 1- trajectory classification function
```{r}
...
#Step 3- application of function for annual timesteps
```{r}
...
trajectory_function <- function (index_name, swinfolder_input, climate_zone, value_int_or_trend, swinfolder_output){
  ...
  write_rds(compiled_df, paste0(index_file_path, index_name, "/", "TrajectoryShapes/annual/",swinfolder_output, "/", "trajectory_", climate_zone, ".rds"))
...
#Step 4- application of function for monthly timesteps
```{r}
index_file_path <- "/dungbeetle/home/tg505/Trisha/ecothresholds/Outputs/Indices/"
