...
proj_floristic_regions <- proj_floristic_regions %>% mutate(Region = c("Central-East", "Central-West", "North-East", "North-West", "South","South-East", "South-West", "external North" ))
...
```{r}
write_rds(monthly_agg_ndvi_area , here("Outputs", "TrendsResults", "Figures", "agg_trajectories_floristicregions.rdata"))
...
plotting_function <- function (df){
  ...
  ggplot(df, aes(x = factor(Region, 
                            levels = c("Central-East", "Central-West", "North-East", "North-West", "South", "South-East", "South-West", "external North")), 
...
agg_barplot <- ggplot(df_agg, aes(y = area_sqkm/1000, x = factor(Region, 
                            levels = c("Central-East", "Central-West", "North-East", "North-West", "South", "South-East", "South-West", "external North")), fill =factor(TrajectoryType))) +
