...
anisoEVI_agg_stability<- prop_aggregate(anisoEVI_stability, 0.05) #0.05 is approximately 5x5km
#writeRaster(anisoEVI_agg_stability[[1]],here("Outputs", "Final_TrajShape_Models", "Annual", "agg_stability_am_11_trajresults.tif"))
ndvi_agg_stability<- prop_aggregate(ndvi_stability, 0.05)
#writeRaster(ndvi_agg_stability[[1]],here("Outputs", "Final_TrajShape_Models", "Annual_NDVI", "agg_stability_masked_ndvi_11_trajresults.tif"))
evi_agg_stability<- prop_aggregate(evi_stability, 0.05)
#writeRaster(evi_agg_stability[[1]], here("Outputs", "Final_TrajShape_Models", "Annual_EVI", "agg_stability_masked_evi_11_trajresults.tif"))
