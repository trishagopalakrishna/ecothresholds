...
Sys.time(); modis_mask_proj2<- terra::resample(modis_mask_proj2, monthly_anisoEVI, threads=T); Sys.time()
...
write_rds(mask_df, here("Data",  "Masks_to_define_pixelsofinterest", "caatinga_mask_df2.rds"))
